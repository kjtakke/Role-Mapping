...
$JoinParams = @{
    Left = $Positions
    Right = $roles
    LeftJoinProperty = 'Corps', 'Posn Title', 'Rank'  <# May not be needed#>
    RightJoinProperty = 'Corps', 'Job', 'Rank'        <# May not be needed#>
    Type = 'AllInLeft'
    Prefix = 'InRight_'
}
